...
export default function Ajuda() {
	...
	return (
		<main className="min-h-screen bg-[#d5d6d1] p-0 font-mono text-[#6f7759] md:p-4">
			<div className="flex min-h-[calc(100vh-2rem)] bg-[#f8f8f6] md:rounded-md">
				<Sidebar handleLogout={logout} />
				<section className="min-w-0 flex-1 px-6 py-7 md:px-12 md:py-8">
					<header className="mb-8 border-b border-[#b9bbaa] pb-2 text-sm font-bold">Ajuda</header>
					<div className="mx-auto max-w-[710px]">
						<section className="mb-12 grid items-center gap-5 md:grid-cols-[1fr_170px]">
							<div>
							...
							<img src={heroImage} alt="Ilustração decorativa" className="mx-auto h-36 w-36 object-contain opacity-70" />
						</section>
